...
<body style="margin: 0;">
    <div style="background-color: #ffffff;border-radius: 15px;padding: 10px;font-size: 15px;">
        ...
        <p style="text-align: justify;">
            We noticed you requested for a link to delete your account so we prepared a link for you to be able to complete your action. Click on the button below to proceed.
        </p>
        <div style="display: flex;justify-content: center;">
            <div>
                <a href="http://127.0.0.1:8000/acct/delete/{{ $token }}"><button style="background-color: #000; color: #fff;padding: 10px;border-radius: 5px;border: 0;cursor: pointer;">Delete account</button></a>
            </div>
        </div>
